package basic.sample.map.student_home;
...
class StudentMapSample {
    ...
    public static void main(String[] args) {
        ...
        for (Map.Entry entry : studentGroupMap.entrySet()) {//キーと値のセットを1行 entryに代入
            double sumJap = 0,sumMath = 0,sumEng = 0;
            for (Student student:(List<Student>)entry.getValue()) {  //entryの中身を1データstudentに代入
